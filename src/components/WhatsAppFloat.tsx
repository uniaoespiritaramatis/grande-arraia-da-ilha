...
export function WhatsAppFloat() {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-whatsapp text-whatsapp-foreground shadow-elegant ring-4 ring-whatsapp/15 md:h-16 md:w-16"
    >
